...
public class TestPlateau {
    ...
    public void checkCantMoveNorth() {
        ...
        assertEquals(Status.ERROR_OVER_EDGE, p.move(4, 6, Direction.NORTH));
    }
    ...
    public void checkCantMoveEast() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.ERROR_OVER_EDGE, p.move(5, 3, Direction.EAST));
    }
    ...
    public void checkCantMoveSouth() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.ERROR_OVER_EDGE, p.move(5, 0, Direction.SOUTH));
    }
    ...
    public void checkCantMoveWest() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.ERROR_OVER_EDGE, p.move(0, 3, Direction.WEST));
    }
    ...
    public void checkCanMoveNorth() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.NO_ERROR, p.move(1, 5, Direction.NORTH));
    }
    ...
    public void checkCanMoveEast() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.NO_ERROR, p.move(4, 3, Direction.EAST));
    }
    ...
    public void checkCanMoveSouth() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.NO_ERROR, p.move(1, 1, Direction.SOUTH));
    }
    ...
    public void checkCanMoveWest() {
        // Given a value can the vehicle move 1 space in the given direction?
        Plateau p = new Plateau(5, 6);
        assertEquals(Status.NO_ERROR, p.move(1, 3, Direction.WEST));
    }
}
